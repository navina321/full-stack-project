      ...
      <section className='attraction-card-top'>
        <div className='attraction-card-top__image-container'>
          <img src={
              ...
              } alt = 'image' className='attraction-card-top__image'/>
        </div>
        ...
        <h1 className="attraction-card-top__name attr-info">Advanced Training Lab</h1>
          <div className="attraction-card-top__parks attr-info">
            ...
            <h3 className="attraction-card-top__parks--location attr-info">
              {" "}
              - World Discovery
            </h3>
          </div>
          <h3 className="attraction-card-top__ride attr-info">Ride Type: </h3>
          <h3 className="attraction-card-top__theme attr-info">Theme: </h3>
          <h3 className="attraction-card-top__height attr-info">Height Limit:</h3>
          <h3 className="attraction-card-top__access attr-info">Accessibility:</h3>
        </div>
      </section>
